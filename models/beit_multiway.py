...
class BEiT3(nn.Module):
    ...
    def forward(
        ...
        multiway_split_position = -1  # 多路分割位置为1，左分支/A分支
        ...
        encoder_out = self.encoder(
            ...
            multiway_split_position=multiway_split_position,  # 多路分割位置
        )
        encoder_out["multiway_split_position"] = multiway_split_position  # 将多路分割位置添加到输出中
